...
import { reqApproveMailToAdmin } from "../Models/reqApproveMailToAdmin.js";
...
export const Approve_Req = async (req, res) => {
  try {
    ...
    if (pendingReq) {
      ...
      if (!AproovedAdmin) {
        ...
        if (!dele) {
          ...
          await reqApproveMailToAdmin(AproovedAdmin, SuperAdmin_id);
          client.query("COMMIT");
    ...
    return res.status(500).json({
      errors: "Error in Approving Request.",
