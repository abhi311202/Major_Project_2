export const Admin_Request_Accept_Email = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  <div class="email-container">
    <div class="header">
      <h1>Admin Registration Approved</h1>
    </div>
    
    <div class="content">
      <div class="left-align"> <!-- Wrapper for left-aligned content -->
        <p class="intro-text">
          Congratulations {{admin_name}} ! Your admin registration request has been approved. You now have access to the admin dashboard.
        </p>
        ...
        <p>You can now log in to your admin account using your credentials.</p>
      </div>
      
      <a href="{{loginLink}}" class="action-button">Login</a>
