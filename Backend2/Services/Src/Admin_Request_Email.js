export const Admin_Request_Email = `<!DOCTYPE html>
<html lang="en" >
<head>
  <meta charset="UTF-8" />
            ...
            <tr>
              <td>
                <header class="header" role="banner">
                  ...
                  <p class="intro">A new admin has requested registration. Please review the details below and take the necessary action in LegalAI Application.</p>
                </header>
