export const Admin_Request_Reject_Email = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  <div class="email-container">
    ...
    <div class="content">
      <p class="intro-text">
        Thank you for your interest in becoming an administrator. We appreciate the time you took to submit your application.
      </p>
