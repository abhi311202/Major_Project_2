    ...
    <div className="bg-gradient-to-r from-violet-300 via-green-200 indigo to-red-300 py-16 px-6 md:px-12 ">
      ...
      >
        {teamMembers.map((member) => (
          <div
            key={member.id}
            className="min-w-[300px] max-w-[400px] flex-shrink-0 rounded-3xl bg-gradient-to-br from-blue-300 via-purple-300 to-pink-300 p-1 transition-transform py-4"
          >
...
const teamMembers = [
  ...
  { id: 3, key: "sanskar", url: "https://res.cloudinary.com/dbvwkqrol/image/upload/v1745930958/h6knio3ohfndr6caz8on.jpg", },
